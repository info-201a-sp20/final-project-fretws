...
##Graph of Change in Social Movements During Quarentine

This graph shows the change in society's movements relative to the baseline that has been recorded by Google. The lines colored lines representing categories show the change in habits over time and the efficacy of the stay home orders.
...
This graph represents the number of deaths above the normal baseline. The states with a drastically higher number of deaths can be compared states' pandemic mobility trends shown in the next map.
