intro_page <- tabPanel(
   ...
   p("Covid 19 has changed life as we know it. In order to better understand the effectiveness of these changes,
     ...
     nformation from the State death rates reveal the importance of individual habits on the greater good."),

   img("https://dkr0pu7ej5xex.cloudfront.net/wp-content/uploads/2020/04/03164956/Google-Map-Digital-Magazine-scaled.jpg")
)