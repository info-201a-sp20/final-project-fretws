...
- Google mobility data:
    - [Google](https://www.google.com/covid19/mobility/) released the data after removing identifying user information. The data was generated by counting the number of searches that users of Apple maps completed, and it was sorted by country of origin.
    - 1158 rows
    - 112 columns
