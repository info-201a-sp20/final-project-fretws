...
- Google mobility data:
    ...
    - 1158 rows
    - 112 columns
    - This is useful in analyzing a population's interest in getting out of the house by assessing how many requests for directions are being searched for during the quarantine.
 - Google mobility data:
    ...
    - 327975 rows
    - 11 columns 
    - This is useful in analyzing the types of places the population has been frequenting during the quarantine and how that mobility has changed from the norm.  
